...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        // return $categories;
        return view('backend.admin.tender.category.allcategory', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
       ...
       return redirect()->back()->with('success', 'Catagory has been created successfully !');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.admin.tender.category.edit', compact('category'));
    }
