                        ...
                        <div class="row">
                            <div class="card-body col-5">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" name="type" class="form-control" id="inputEmail3" placeholder="Enter Location">
                                    </div>
                                </div>
                            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$place->name}}</td>
                            <td>
                                <a href="{{url('/type/'.$place->id.'/edit')}}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{url('type/'.$place->id)}}" method="post" style="display:inline-block">
                                    @csrf
                                    @method('DELETE')
