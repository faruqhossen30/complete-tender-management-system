                        ...
                        @foreach ($clients as $client)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ('1' == $client->active)
                                        <a href="{{ route('change-status', $client->id) }}" class="btn btn-success btn-sm"
                                            title="Click for deactivate">Active</a>
                                    @else
                                        <a href="{{ route('change-status', $client->id) }}" class="btn btn-warning btn-sm"
                                            title="Click for activate">Deactive</a>
