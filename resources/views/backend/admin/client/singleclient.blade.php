            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle" src="{{ asset('public/images/logo.png') }}"
                    ...
                    <table class="table table-bordered mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>7.</td>
                                <td>All Document</td>
                                <td><strong><a href="{{ route('document', $client->id) }}"
                                            class="btn btn-success btn-sm">Check Documents</a></strong></td>
                            </tr>
                            <tr>
                                <td>8.</td>
                                <td>Join Date</td>
